...
The Challenge: A small art gallery is selling works from different artists and wants to keep track of the paintings using an SQL database. You need to create a user-friendly system to keep track of the art. This should include using a GUI.


art_gallery.py (150.py)
========================================================
...
def viewartists():
    ...
    for x in cursor.fetchall():
        newrecord = "{},{},{},{},{},{}\n".format( str(x[0]),str(x[1]),str(x[2]),str(x[3]),str(x[4]),x[5] )
...
![Sample output Art Gallery](https://github.com/nihathalici/Python-By-Example/blob/main/CHL-150-Art-Gallery/sample_output_art_gallery_150_py.png)
